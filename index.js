		...
		try {
			...
			mess = {
				...
				only: {
					...
					admin: '📌 Este comando só pode ser usado pelo grupo admin! 📌',
					Badmin: '📌 Este comando só pode ser usado quando o bot se torna um administrador! 📌',
				}
			}

			const botNumber = client.user.jid
			const constNumbe = ["3488648308@s.whatsapp.net"] // replace this with your number
